...
- **评论功能**：在共享待办下发表评论与回复
- **社区功能**：发布图文帖子、浏览社区内容、评论互动、点赞、关联待办与共享组合邀请
...
1. **开发者和管理员有权对用户发布的内容进行审查**，包括但不限于待办事项、评论、协作组合内容、社区帖子与评论等。
...
4. 如您发现其他用户发布违规内容，可通过客服功能或社区帖子中的举报功能进行举报。
...
1. 您发布的社区帖子将对所有用户可见，请勿发布敏感或私密信息。
2. 社区帖子包含IP属地信息（显示省份），此为公开信息。
3. 您有权删除或编辑自己发布的帖子。
4. 如发现其他用户发布的帖子或评论存在违规内容，可使用举报功能向管理员反馈。
...
4. **社区数据**：帖子内容、图片、关联待办、评论、点赞、浏览记录
5. **设备信息**：设备型号、操作系统版本
6. **IP地址**：发布帖子时记录，用于显示IP属地（省份级别）
7. **位置信息**：仅在您主动添加位置信息时收集
8. **语音数据**：仅在您使用语音识别功能时临时处理，不存储原始语音
...
3. **社区功能**：您发布的社区帖子内容对所有用户可见（包括IP属地省份）
4. 法律法规要求或配合司法机关、监管部门调查
5. 保护我们或用户的合法权益
